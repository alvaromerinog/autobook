...
class _ConfirmResetState extends State<ConfirmReset> {
  ...
  void _verifyCode(BuildContext context, password) async {
    try{
      ...
      await Amplify.Auth.confirmPassword(username: email, newPassword: password, confirmationCode: code);
      await Amplify.Auth.signIn(username: email, password: password);
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('La contraseña ha sido reestablecida.'), backgroundColor: Colors.blue,));
